...
const feeBodySchema = z.object({
  ...
  length: z.coerce.number().min(1).default(150),
  width: z.coerce.number().min(1).default(60),
  height: z.coerce.number().min(1).default(90),
  weight: z.coerce.number().min(1).default(50000),
