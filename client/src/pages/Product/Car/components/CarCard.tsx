...
const CarCard: React.FC<CarCardProps> = ({ car }) => {
    ...
    return (
        <Card
            ...
            className="bg-white border border-gray-200 rounded-2xl shadow-sm hover:shadow-xl hover:border-yellow-400 transition-all duration-300 p-0 overflow-hidden flex flex-col cursor-pointer group"
        >
