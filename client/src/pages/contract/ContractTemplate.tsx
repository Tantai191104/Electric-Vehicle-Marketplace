...
export const ContractTemplate = React.forwardRef<HTMLDivElement, Props>(
    ({ contractData, signerSigRef, onClearSignature }, ref) => {
        return (
            <div
                ref={ref}
                style={{
            ...
            >
                    ...
                    >
                        <tbody>
                            ...
                            <tr>
                                ...
                                >
                                    {new Intl.NumberFormat("vi-VN").format(contractData.price)} VNĐ (
                                    {contractData.priceInWords})
                                </td>
                            </tr>
                            <tr>
                ...
                >
                    <p>
                        Hợp đồng này được lập thành 01 bản có giá trị pháp lý và được lưu giữ
                        bởi người ký.
                    </p>
...
const SignatureSection: React.FC<SignatureSectionProps> = ({
    ...
    <div style={{ flex: "1", textAlign: "center" }}>
        ...
        <div style={{ position: "relative" }}>
            {/* QUAN TRỌNG: Có data-signature để replace */}
...
const terms = [
    {
        ...
        content:
            "Bên bán cam kết chiếc xe thuộc quyền sở hữu hợp pháp, không có tranh chấp, không thế chấp, đã thanh toán đầy đủ các khoản phí, lệ phí theo quy định của pháp luật.",
    },
    {
        title: "Điều 2 - Nghĩa vụ của bên mua",
        content:
            "Bên mua cam kết thanh toán đủ số tiền đã thỏa thuận và nhận bàn giao xe trong vòng 03 ngày làm việc kể từ ngày ký hợp đồng này.",
    },
    {
        title: "Điều 3 - Bàn giao xe",
        content:
            "Bên bán có trách nhiệm bàn giao xe cùng với toàn bộ giấy tờ pháp lý: giấy đăng ký xe, bảo hiểm, sổ bảo hành (nếu còn) cho bên mua.",
    },
    {
        title: "Điều 4 - Giải quyết tranh chấp",
        content:
            "Hai bên cam kết thực hiện đúng các điều khoản đã thỏa thuận. Nếu có tranh chấp phát sinh, hai bên sẽ giải quyết thông qua thương lượng, hòa giải. Trường hợp không thể giải quyết được sẽ đưa ra Tòa án có thẩm quyền.",
    },
];
