...
export const ChatMessages: React.FC<ChatMessagesProps> = ({ messages, darkMode = true }) => {
    ...
    return (
        <div
            ref={containerRef}
            className={`flex-1 overflow-y-auto ${darkMode ? "bg-gray-900" : "bg-white"} p-2`}
        >
            {messages.map((msg, index) => {
                ...
                const isLastInGroup = nextMsg ? !shouldGroupWithPrevious(nextMsg, msg) : true;
