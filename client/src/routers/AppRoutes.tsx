...
import BatteryEditor from "@/pages/article/BatteryEditor";
    ...
    <AnimatePresence mode="wait">
      <Routes location={location} key={location.pathname}>
        ...
        <Route element={<StandardLayout />}>
          <Route path="/chat" element={animatePage(<ChatPage />)} />
          <Route path="/articles/new" element={animatePage(<BatteryEditor />)} />
